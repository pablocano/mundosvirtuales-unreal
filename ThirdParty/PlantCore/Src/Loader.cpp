...
Loader::Loader(std::string _db_name, std::string _db_user, std::string _db_password, std::string _db_engine) :
	db_name(_db_name), db_user(_db_user), db_password(_db_password), db_engine(_db_engine), 
