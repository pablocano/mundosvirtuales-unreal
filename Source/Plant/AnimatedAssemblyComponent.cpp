...
void UAnimatedAssemblyComponent::Init(APlantActor* actorPointer, UMeshComponent* parentComponent, StockPlant const *stockEntry)
{
	...
	FString animationName = FString(modelAnimationName.c_str());
	...
	this->OnBeginCursorOver.AddDynamic(this, &UAnimatedAssemblyComponent::CustomOnBeginMouseOver);
	this->OnEndCursorOver.AddDynamic(this, &UAnimatedAssemblyComponent::CustomOnEndMouseOver);
	this->OnClicked.AddDynamic(this, &UAnimatedAssemblyComponent::CustomOnBeginMouseClicked);
...
void UAnimatedAssemblyComponent::BeginPlay()
{
	...
	if (widgetInfoComponent)
	{
		...
		widgetInfo->buttonOk->OnClicked.AddDynamic(this, &UAnimatedAssemblyComponent::OnClickButtonOk);
		widgetInfoComponent->OnClicked.AddDynamic(this, &UAnimatedAssemblyComponent::OnClickWidgetComponent);
...
bool UAnimatedAssemblyComponent::IsSelected_Implementation()
{
	return selected;
}

UMeshComponent* UAnimatedAssemblyComponent::GetParent_Implementation()
{
	return parent;
}

// Set the selection status of this component
void UAnimatedAssemblyComponent::SetSelected_Implementation(bool select)
{
	// Set the selection
	selected = select;
...
void UAnimatedAssemblyComponent::Collapse_Implementation(UMeshComponent* activeRoot)
{
...
void UAnimatedAssemblyComponent::ShowComponent_Implementation()
{
...
void UAnimatedAssemblyComponent::UnregisterStock_Implementation()
{
...
void UAnimatedAssemblyComponent::RemoveFocus_Implementation()
{
	// Set the borders to nothing
	SetBorders(NOTHING);
}
...
FTransform UAnimatedAssemblyComponent::GetGlobalPosition_Implementation()
{
...
// Process the visualization mode
void UAnimatedAssemblyComponent::ProcessVisualizationMode_Implementation()
{
...
void UAnimatedAssemblyComponent::SetHover(bool hover)
{
	// If the material can be accessed
	for (int i = 0; i < DynMaterials.Num(); i++)
	{
...
void UAnimatedAssemblyComponent::CustomOnBeginMouseClicked(UPrimitiveComponent * TouchedComponent, FKey key)
{
...
// Hide this component
void UAnimatedAssemblyComponent::Hide()
{
	SetVisibility(false);
...
void UAnimatedAssemblyComponent::SetBorders(FocusStatus status)
{
...
// Expand this component
void UAnimatedAssemblyComponent::ExpandComponent()
{
...
void UAnimatedAssemblyComponent::OnClickWidgetComponent(UPrimitiveComponent* pComponent, FKey inKey)
{
	if (GEngine)
	{
